...
// (N�cessite le package NuGet Microsoft.Extensions.Hosting.WindowsServices)
builder.Services.AddWindowsService(options =>
{
    // C'est le nom officiel sous lequel le service sera enregistr� dans services.msc
...
// On redirige les logs vers l'Observateur d'�v�nements Windows (Event Viewer).
...
// 4. Construction et ex�cution bloquante
